    ...
    <>
      ...
      <div className="row justify-content-evenly pt-2 pb-5 bg-dark text-white mt-5 footer mx-auto">
        <div className="col-md-3 pt-4">
          <h5 className="pb-2">Jay Food Adda</h5>
          <p>Jay Food Adda offers a unique dining experience with high-quality foods, authentic and original recipes, and fast delivery service. Visit us and enjoy delicious food today!</p>
        </div>
        <div className="col-md-3 pt-4">
        ...
        <div className="col-md-3 pt-4">
          ...
          <p>Jay Food Adda, Gujarat <br />
            india - 361120 <br />
            <i className="bi bi-telephone"></i> Mobile No : 9999999999
            <br/>
            <NavLink to="https://www.linkedin.com/in/jay-kanani-9221a9203/" target='_blank'><i className="bi bi-linkedin social-icon"></i></NavLink>
      ...
      <div className="row bg-secondary text-white text-center copyright">
        <div className="col-12 ">
          <p>copyright &copy; by jay food adda, All Right Reserved</p>
        </div>
      </div>
