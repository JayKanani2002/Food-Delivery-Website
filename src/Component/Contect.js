    ...
    <>
      ...
      <div className="row justify-content-evenly pt-2  contect">
        ...
        <div className="col-md-5 col-11 mt-5">
          <div className='col-12 text-center mt-5'><h1 className='namehead'>Jay Food Adda</h1></div>
          <div className='col-12 text-center mt-5'> <h3 className=''>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
              <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
            </svg> Address</h3> </div>
          <div className='col-12 text-center mt-4'>  <p className='addres'>  Jamnagar-Rajkot Highway <br /> Dist - Jamnagar, State-Gujarat, India</p></div>
          <div className='col-12 text-center mt-5'><h5><strong>Mail-Id </strong>: jaykanani30@gmail.com</h5></div>
